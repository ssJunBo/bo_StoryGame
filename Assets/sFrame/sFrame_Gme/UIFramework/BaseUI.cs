...
public class BaseUI
{
    ...
    public virtual bool OnMessage(EUIMshID msgID, params object[] paraList) { return true; }
    ...
    public bool ChangeImageSprite(string path, Image image, bool setNativeSize = false)
    {
        ...
        Sprite sp = ResourceManager.Instance.LoadResouce<Sprite>(path);
        if (sp != null)
        {
    ...
    public void ChangeImageSpriteAsync(string path, Image image, bool setNativeSize = false)
    {
        ...
        ResourceManager.Instance.AsyncLoadResource(path, OnLoadSpriteFinish, ELoadResPriority.RES_MIDDLE, true, image, setNativeSize);
    }
